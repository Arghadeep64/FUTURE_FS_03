document.addEventListener('DOMContentLoaded', function() {
    ...
    if (signinForm) {
        signinForm.onsubmit = function(e) {
            ...
            const user = JSON.parse(localStorage.getItem('streamboxUser'));
    ...
    if (signupForm) {
        signupForm.onsubmit = function(e) {
            ...
            localStorage.setItem('streamboxUser', JSON.stringify(user));
    ...
    if (document.querySelector('.dashboard-user')) {
        ...
        const loadUserData = () => {
            try {
                const userData = localStorage.getItem('streamboxUser');
                if (userData) {
